...
static void setup_multisynth(uint8_t clk, uint8_t pllSource, uint32_t divider, uint32_t num, uint32_t denom,
...
static void set_frequency_fixedpll(int clk, int pll, uint32_t pllfreq, uint32_t freq, int rdiv,
